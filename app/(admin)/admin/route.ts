...
// closed to a flat 404 for anyone without the admin role — see
// app/(editor)/editorial/route.ts for why this stays a Route Handler rather
// than a page. No nav entry links here yet; real admin tooling is a later
// prompt.
export async function GET() {
  ...
  return NextResponse.json({
    ok: true,
    role: access.role,
    message: "Admin tooling is not built yet.",
  });
}
